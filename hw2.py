...
for i, j in enumerate(data):
    if data[i]['city'] == 'Kiev':
        kiev.append(dict(name=data[i]['name'], age=data[i]['age']))
        result.update({data[i]['city']: kiev})
    elif data[i]['city'] == 'Dnepr':
        dnepr.append(dict(name=data[i]['name'], age=data[i]['age']))
        result.update({data[i]['city']: dnepr})
    elif data[i]['city'] == 'Lviv':
        lviv.append(dict(name=data[i]['name'], age=data[i]['age']))
        result.update({data[i]['city']: lviv})
